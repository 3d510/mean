...
var updateRating = function (locationid) {
    Loc.findById(locationid).selected('rating reviews').exec(function (err,location) {
        if (!err) {
...
var doSetAverageRating = function(location) {
    ...
    if (reviewCount > 0) {
        for (var i = 0; i < reviewCount; i++) {
            reviewTotal += location.reviews[i].rating;
        }
        ratingAverage = parseInt(reviewTotal/reviewCount,10);
